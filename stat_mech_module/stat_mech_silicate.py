 ...
 =============================================================================
    ...
    if frac is None:
        ...
        for i in draw_ar:
            ...
            p4 = Q4[-1]*w_Q4[i] / ((Q4[-1]*w_Q4[i])+(Q3[-1]*w_Q3[i])+(Q2[-1]*w_Q2[i])+(Q1[-1]*w_Q1[i]))
            p3 = Q3[-1]*w_Q3[i] / ((Q4[-1]*w_Q4[i])+(Q3[-1]*w_Q3[i])+(Q2[-1]*w_Q2[i])+(Q1[-1]*w_Q1[i]))
            p2 = Q2[-1]*w_Q2[i] / ((Q4[-1]*w_Q4[i])+(Q3[-1]*w_Q3[i])+(Q2[-1]*w_Q2[i])+(Q1[-1]*w_Q1[i]))
            p1 = Q1[-1]*w_Q1[i] / ((Q4[-1]*w_Q4[i])+(Q3[-1]*w_Q3[i])+(Q2[-1]*w_Q2[i])+(Q1[-1]*w_Q1[i]))
        ...
        for i in draw_ar:
            ...
            p4 = ((Q4[-1]*w_K_Q4[i] / ((Q4[-1]*w_K_Q4[i])+(Q3[-1]*w_K_Q3[i])+(Q2[-1]*w_K_Q2[i])+(Q1[-1]*w_K_Q1[i])))*frac[0]) + ((Q4[-1]*w_Na_Q4[i] / ((Q4[-1]*w_Na_Q4[i])+(Q3[-1]*w_Na_Q3[i])+(Q2[-1]*w_Na_Q2[i])+(Q1[-1]*w_Na_Q1[i])))*frac[1])
            p3 = ((Q3[-1]*w_K_Q3[i] / ((Q4[-1]*w_K_Q4[i])+(Q3[-1]*w_K_Q3[i])+(Q2[-1]*w_K_Q2[i])+(Q1[-1]*w_K_Q1[i])))*frac[0]) + ((Q3[-1]*w_Na_Q3[i] / ((Q4[-1]*w_Na_Q4[i])+(Q3[-1]*w_Na_Q3[i])+(Q2[-1]*w_Na_Q2[i])+(Q1[-1]*w_Na_Q1[i])))*frac[1])
            p2 = ((Q2[-1]*w_K_Q2[i] / ((Q4[-1]*w_K_Q4[i])+(Q3[-1]*w_K_Q3[i])+(Q2[-1]*w_K_Q2[i])+(Q1[-1]*w_K_Q1[i])))*frac[0]) + ((Q2[-1]*w_Na_Q2[i] / ((Q4[-1]*w_Na_Q4[i])+(Q3[-1]*w_Na_Q3[i])+(Q2[-1]*w_Na_Q2[i])+(Q1[-1]*w_Na_Q1[i])))*frac[1])
            p1 = ((Q1[-1]*w_K_Q1[i] / ((Q4[-1]*w_K_Q4[i])+(Q3[-1]*w_K_Q3[i])+(Q2[-1]*w_K_Q2[i])+(Q1[-1]*w_K_Q1[i])))*frac[0]) + ((Q1[-1]*w_Na_Q1[i] / ((Q4[-1]*w_Na_Q4[i])+(Q3[-1]*w_Na_Q3[i])+(Q2[-1]*w_Na_Q2[i])+(Q1[-1]*w_Na_Q1[i])))*frac[1])
    ...
    if s_plt is False and p is True:
        plt.plot(M2O, Q4, 'r-', M2O, Q3, 'k-', M2O, Q2, 'b-', M2O, Q1, 'g-', M2O, Q0, 'y-',)
        plt.axis([0, 67, 0, 100])
...
def Si_SSE(H1,  data, tg, frac = None, s_plt = False, s_dat = False, p = False):
 ...
 =============================================================================
    ...
    if p is False:
        ...
        SSE = sum(((Q4_data - Q4_m)**2)+((Q3_data - Q3_m)**2)+((Q2_data - Q2_m)**2)+
...
def Si_engine(fil, data, tg, it = 10):
    ...
    res = scipy.optimize.basinhopping(Si_SSE, w0, niter=it, T=2.0, stepsize=1, 
