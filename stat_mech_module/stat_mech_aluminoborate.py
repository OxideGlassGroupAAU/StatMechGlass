...
def AlB_first_draw(w1, start_conc, former):
    ...
    # Startværdier
        ...
        if Al5[-1] > 0: 
            while (Al_draw[-1]/3)*100/(100+(Al_draw[-1]/3)) < Al5[-1]*100/(100-Al4A[-1]):
                gQ4 = (Q4[-1]*w[0])*(1/(r+1)) / (Q4[-1]*w[0]+Q3A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ3 = (Q3A[-1]*w[1])*(1/(r+1)) / (Q4[-1]*w[0]+Q3A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ2 = (Q2A[-1]*w[2])*(1/(r+1)) / (Q4[-1]*w[0]+Q3A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ1 = (Q1AA[-1]*w[3])*(1/(r+1)) / (Q4[-1]*w[0]+Q3A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gAl5 = (Al5[-1]*w[4])*(1/(r+1)) / (Q4[-1]*w[0]+Q3A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
            ...
            gQ4 = balance_draw*(Q4[-2]*w[0])*(1/(r+1)) / (Q4[-2]*w[0]+Q3A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ3 = balance_draw*(Q3A[-2]*w[1])*(1/(r+1)) / (Q4[-2]*w[0]+Q3A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ2 = balance_draw*(Q2A[-2]*w[2])*(1/(r+1)) / (Q4[-2]*w[0]+Q3A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ1 = balance_draw*(Q1AA[-2]*w[3])*(1/(r+1)) / (Q4[-2]*w[0]+Q3A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gAl5 = balance_draw*(Al5[-2]*w[4])*(1/(r+1)) / (Q4[-2]*w[0]+Q3A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
    ...
    # Startværdier
        ...
        if Al5[-1] > 0: 
            while (Al_draw[-1]/3)*100/(100+(Al_draw[-1]/3)) < Al5[-1]*100/(100-Al4A[-1]):
                gQ3 = (Q3[-1]*w[0])*(1/(r+1)) / (Q3[-1]*w[0]+Q4A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ4 = (Q4A[-1]*w[1])*(1/(r+1)) / (Q3[-1]*w[0]+Q4A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ2 = (Q2A[-1]*w[2])*(1/(r+1)) / (Q3[-1]*w[0]+Q4A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gQ1 = (Q1AA[-1]*w[3])*(1/(r+1)) / (Q3[-1]*w[0]+Q4A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
                gAl5 = (Al5[-1]*w[4])*(1/(r+1)) / (Q3[-1]*w[0]+Q4A[-1]*w[1]+Q2A[-1]*w[2]+Q1AA[-1]*w[3]+Al5[-1]*w[4])
            ...
            gQ3 = balance_draw*(Q3[-2]*w[0])*(1/(r+1)) / (Q3[-2]*w[0]+Q4A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ4 = balance_draw*(Q4A[-2]*w[1])*(1/(r+1)) / (Q3[-2]*w[0]+Q4A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ2 = balance_draw*(Q2A[-2]*w[2])*(1/(r+1)) / (Q3[-2]*w[0]+Q4A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gQ1 = balance_draw*(Q1AA[-2]*w[3])*(1/(r+1)) / (Q3[-2]*w[0]+Q4A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
            gAl5 = balance_draw*(Al5[-2]*w[4])*(1/(r+1)) / (Q3[-2]*w[0]+Q4A[-2]*w[1]+Q2A[-2]*w[2]+Q1AA[-2]*w[3]+Al5[-2]*w[4])
...
# Startværdier
    ...
    if Al5[-1] > 0: 
        while (Al_draw[-1]/3)*100/(100+(Al_draw[-1]/3)) < Al5[-1]*100/(100-Al4A[-1]):
            gQ3 = (Q3[-1]*w[6])*(1/(r+1)) / (Q3[-1]*w[6]+Q4A[-1]*w[7]+Q2A[-1]*w[8]+Q1AA[-1]*w[9]+Al5[-1]*w[10])
            gQ4 = (Q4A[-1]*w[7])*(1/(r+1)) / (Q3[-1]*w[6]+Q4A[-1]*w[7]+Q2A[-1]*w[8]+Q1AA[-1]*w[9]+Al5[-1]*w[10])
            gQ2 = (Q2A[-1]*w[8])*(1/(r+1)) / (Q3[-1]*w[6]+Q4A[-1]*w[7]+Q2A[-1]*w[8]+Q1AA[-1]*w[9]+Al5[-1]*w[10])
            gQ1 = (Q1AA[-1]*w[9])*(1/(r+1)) / (Q3[-1]*w[6]+Q4A[-1]*w[7]+Q2A[-1]*w[8]+Q1AA[-1]*w[9]+Al5[-1]*w[10])
            gAl5 = (Al5[-1]*w[10])*(1/(r+1)) / (Q3[-1]*w[6]+Q4A[-1]*w[7]+Q2A[-1]*w[8]+Q1AA[-1]*w[9]+Al5[-1]*w[10])
        ...
        gQ3 = balance_draw*(Q3[-2]*w[6])*(1/(r+1)) / (Q3[-2]*w[6]+Q4A[-2]*w[7]+Q2A[-2]*w[8]+Q1AA[-2]*w[9]+Al5[-2]*w[10])
        gQ4 = balance_draw*(Q4A[-2]*w[7])*(1/(r+1)) / (Q3[-2]*w[6]+Q4A[-2]*w[7]+Q2A[-2]*w[8]+Q1AA[-2]*w[9]+Al5[-2]*w[10])
        gQ2 = balance_draw*(Q2A[-2]*w[8])*(1/(r+1)) / (Q3[-2]*w[6]+Q4A[-2]*w[7]+Q2A[-2]*w[8]+Q1AA[-2]*w[9]+Al5[-2]*w[10])
        gQ1 = balance_draw*(Q1AA[-2]*w[9])*(1/(r+1)) / (Q3[-2]*w[6]+Q4A[-2]*w[7]+Q2A[-2]*w[8]+Q1AA[-2]*w[9]+Al5[-2]*w[10])
        gAl5 = balance_draw*(Al5[-2]*w[10])*(1/(r+1)) / (Q3[-2]*w[6]+Q4A[-2]*w[7]+Q2A[-2]*w[8]+Q1AA[-2]*w[9]+Al5[-2]*w[10])
...
def AlB_SSE(w, data, frac = None, s_plt = False, s_dat = False, p = False):
    ...
    for i in range(len(mod_data)):
        mod_m, Q3_m, Q4_m, Q2_m, Q1_m, Q0_m, Al5_mod, Al4_mod = AlB_draw(w, r_data[i], mod_data[i])
    ...
    if s_plt is False and p is True:
        t = list(range(100))
        plt.plot(B4_data, B4_m, 'rd', B3_data, B3_m, 'bd', B2_data, B2_m, 'gd', B1_data, B1_m, 'yd', Al4_data, Al4_m, 'kd', 
                 Al5_data, Al5_m, 'cd'
                 )
        plt.plot(t, t, 'k--')
    ...
    if s_dat is True:
        if not os.path.exists("AlB_Structure"):
            os.mkdir("AlB_Structure")        
        m_data_plt_kval = np.column_stack([B3_data, B3_m, B4_data, B4_m, B2_data, B2_m, B1_data, B1_m, Al4_data, Al4_m, Al5_data, Al5_m])
        np.savetxt(os.path.join('AlB_Structure','Model_v_data.csv'), m_data_plt_kval)


    if p is False:

        SSE = sum(((B4_data - B4_m)**2)+((B3_data - B3_m)**2)+((B2_data - B2_m)**2)+
                  ((B1_data - B1_m)**2)+((B0_data - B0_m)**2)+((Al5_data - Al5_m)**2)+((Al4_data - Al4_m)**2))
...
def AlB_engine(fil, data, it = 10):
    ...
    res = scipy.optimize.basinhopping(AlB_SSE, w0, niter=it, T=2.0, stepsize=5, 
